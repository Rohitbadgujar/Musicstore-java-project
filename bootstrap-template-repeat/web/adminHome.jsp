      ...
      <div class="row">
        ...
        <div class="col-lg-3 mb-4">
          <div class="list-group">
            ...
            <a href="/bootstrap-template-repeat/Product?function=viewProductList" class="list-group-item" >Products</a>
            <a href="Cart.jsp" class="list-group-item" >Cart</a>
            <a href="SalesReport.jsp" class="list-group-item" >Sales Report</a>
            <a href="UserActivityReport.jsp" class="list-group-item" >User Activity Report</a>
            <a href="InventoryLevelReport.jsp" class="list-group-item" >Inventory Level Report</a>
